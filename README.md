...
- A JS script to extract post and reel links from Instagram collection pages and downloads a `.txt` file containing them;
- Two Python scripts to download reels from the list of links generated by the JS scripts.
